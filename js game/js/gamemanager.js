...
setPreFight: function() { 
   ...
   setFight: function() {
    ...
    getEnemy.innerHTML = '<img src = "img/avatar-enemies/' + enemy.enemyType.toLowerCase() + '.png" alt="' + enemy.enemyType + '"class="img-avatar"><div><h3>' + enemy.enemyType + '<h3><p class="health-enemy">Health: ' + enemy.health + '</p><p>Agility: ' + enemy.agility + '</p><p>Speed: ' + enemy.speed + '</p></div>';
}
}